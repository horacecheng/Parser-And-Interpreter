...
public class A6
{
  ...
  System.out.println();     
    ...
    test("car ( [ `s13 [ `s23 `s33 ] `s43 ] ) ");
    test("cdr ( [ `s14 [ `s24 `s34 ] `s44 ] ) ");
    test("car ( [ [ `s25 `s35 ] `s15 `s45 ] ) ");
    test("cdr ( [ [ `s26 `s36 ] `s16 `s46 ] ) ");
    test("cons ( `s07 [ `s17 [ `s27 `s37 ] `s47 ] )");
    test("cons ( [ `s19 [ `s29 `s39 ] `s49 ] [ `s18 [ `s28 `s38 ] `s48 ] )");
